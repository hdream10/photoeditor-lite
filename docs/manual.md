...
Ознакомиться с методиками разработки мобильных приложений на React Native, изучить основные концепции, инструменты и подходы к созданию кроссплатформенных приложений. Получить практический опыт разработки на примере создания приложения для редактирования фотографий.
